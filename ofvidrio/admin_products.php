...
<section class="add-products">
   ...
   <h1 class="title">Tienda Productos</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="image" accept="image/jpg, image/jpeg, image/png, image/gif" class="box" required>
      <input type="submit" value="Añadir productos" name="add_product" class="btn">
   </form>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" class="box" name="update_image" accept="image/jpg, image/jpeg, image/png, image/gif">
